...
import { toast } from '../lib/storage.js';
    ...
    <Layout title="Physician Export" activeTab="my-care">
      <main className="ml-64 p-container-padding-desktop min-h-screen">
        <div className="max-w-5xl mx-auto space-y-stack-lg">
          ...
          <div className="flex justify-between items-center no-print fade-in">
            <div>
            ...
            <button onClick={() => window.print()} className="bg-primary text-on-primary px-6 py-3 rounded-xl font-bold flex items-center gap-2 clinical-shadow hover:opacity-90 active:scale-95 transition">
          ...
          <section className="bg-surface-container-lowest clinical-shadow rounded-xl overflow-hidden border border-surface-variant">
            <div className="print-canvas p-stack-lg sm:p-10">
              ...
              <div className="flex justify-between items-start border-b-2 border-primary pb-stack-lg mb-stack-lg">
                <div>
                ...
                <div className="text-right">
                  <p className="font-bold text-primary text-headline-sm flex items-center gap-2 justify-end">
                    <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>spa</span> Clinical Harmony
                  </p>
                ...
                <div className="col-span-12 lg:col-span-7 space-y-stack-lg">
                  <div className="p-stack-lg bg-surface-container-low rounded-lg status-card-alert">
                    ...
                    <div className="space-y-stack-md">
                      <div className="flex gap-4"><div className="w-2 h-2 rounded-full bg-error mt-2 shrink-0" /><p className="text-body-md"><span className="font-bold">Circadian Shift:</span> Symptom onset has shifted 4 hours earlier (from 16:00 → 12:00) over the last 7 days.</p></div>
                      <div className="flex gap-4"><div className="w-2 h-2 rounded-full bg-error mt-2 shrink-0" /><p className="text-body-md"><span className="font-bold">Intensity Escalation:</span> Self-reported pain peaked at 8/10 for 3 consecutive days, exceeding the 30-day baseline.</p></div>
                      <div className="flex gap-4"><div className="w-2 h-2 rounded-full bg-secondary mt-2 shrink-0" /><p className="text-body-md"><span className="font-bold">Medication Correlation:</span> "Dizziness" events occurred 45 minutes post-medication on 5 occasions.</p></div>
                    </div>
                  </div>
                  ...
                  <div className="p-stack-lg bg-surface-container-low rounded-lg">
                    ...
                    <div className="grid grid-cols-1 gap-stack-md">
                      <div className="p-4 bg-white rounded border border-surface-variant">
                  ...
                  <div className="p-stack-lg bg-surface-container-low rounded-lg">
                    <div className="flex items-center gap-2 mb-stack-md">
                      <span className="material-symbols-outlined text-status-safe">eco</span>
                      <h3 className="text-headline-sm font-headline-sm">Positive Indicators</h3>
                    </div>
                    <ul className="space-y-2 text-body-md">
                      <li className="flex items-start gap-3"><span className="material-symbols-outlined text-status-safe text-base mt-1">check_circle</span> Medication adherence: <strong className="ml-1">100%</strong> for 14 consecutive days.</li>
                      <li className="flex items-start gap-3"><span className="material-symbols-outlined text-status-safe text-base mt-1">check_circle</span> Resting heart-rate variability improved by <strong className="ml-1">8%</strong>.</li>
                      <li className="flex items-start gap-3"><span className="material-symbols-outlined text-status-safe text-base mt-1">check_circle</span> Hydration goal met on <strong className="ml-1">26/30</strong> days.</li>
                    </ul>
                  </div>
                </div>

                <div className="col-span-12 lg:col-span-5 flex flex-col gap-stack-lg">
                  <div className="p-stack-lg bg-white border border-surface-variant rounded-lg flex-1">
                  ...
                  <div className="p-stack-lg bg-primary text-on-primary rounded-lg">
                    ...
                    <ul className="text-body-md mt-2 space-y-2">
                      <li className="flex items-start gap-2"><span className="material-symbols-outlined text-sm mt-1">arrow_forward</span>Adjust late-afternoon caffeine cutoff to 1 PM.</li>
                      <li className="flex items-start gap-2"><span className="material-symbols-outlined text-sm mt-1">arrow_forward</span>Evaluate post-medication dizziness window.</li>
                      <li className="flex items-start gap-2"><span className="material-symbols-outlined text-sm mt-1">arrow_forward</span>Review supplement dose at next visit.</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-stack-lg pt-stack-lg border-t border-surface-variant grid grid-cols-1 md:grid-cols-3 gap-stack-lg">
                ...
                <div className="text-right"><p className="text-body-sm text-on-surface-variant">Confidential Patient Information · For Clinical Use Only</p></div>
              </div>
            </div>
          </section>

          <div className="flex flex-col sm:flex-row justify-end gap-stack-md pb-20 no-print">
            <button className="px-6 py-3 border-2 border-primary text-primary rounded-xl font-bold hover:bg-primary/5 transition">Modify Date Range</button>
            <button
              onClick={() => toast('Report transmitted to EHR · Confirmation #CH-8829')}
              className="px-10 py-3 bg-primary text-on-primary rounded-xl font-bold clinical-shadow hover:opacity-90 transition flex items-center justify-center gap-3"
            >
              <span className="material-symbols-outlined">send</span> Send to EHR
            </button>
          </div>
        </div>
      </main>
